...
COMMAND_MODULES = {
    ...
    "conform-interface": "blab.interface_conform",
    "gui": "blab.gui",
    "server": "blab.server",
    "solve": "blab.solver",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog="Use 'blab project validate' and 'blab project solve' for physical-system solves. 'blab server' provides an experimental localhost CPU service.",
    )
