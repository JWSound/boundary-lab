"""Export prepared balloon surfaces for external realtime visual tools."""
...
def export_touchdesigner_balloon_data(
    ...
    arrays keep their grid dimensions so TouchDesigner users can consume either
