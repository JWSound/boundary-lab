...
cpu_pressure = solve_burton_miller_neumann(cpu_ops, identity_p1_p1, identity_p1_dp0, q_neumann, k, false)
gpu_pressure = solve_burton_miller_neumann(gpu_ops, identity_p1_p1, identity_p1_dp0, q_neumann, k, true)
