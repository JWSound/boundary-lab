...
the solve. Solver quantities, channel delay and crossover processing, and
displayed/exported phase all use the standard audio `exp(+i omega t)` convention.
Legacy negative-time packages are converted when loaded.
