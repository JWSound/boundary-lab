# Legacy server Docker image retirement

The former CUDA server image is retired with the source-model HTTP protocol.
Its Dockerfile and startup scripts have been removed.
